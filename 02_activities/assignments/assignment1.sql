...
OR  product_id LIKE 9; -- No customer purchases of product ID 9.
...
SELECT vendor_name, market_date FROM vendor as v
INNER JOIN 
...
SELECT vendor_id, COUNT(vendor_id) as rented_a_booth FROM vendor_booth_assignments
GROUP BY vendor_id;
